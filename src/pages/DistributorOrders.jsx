    ...
    <div className="max-w-5xl mx-auto p-4 sm:p-6 pb-24">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-base font-semibold text-[var(--saathi-text-secondary)] mt-1.5">Review and approve inventory shipments from Wholesalers</p>
        </div>
      </div>
          ...
          orders.map(order => (
            <div key={order._id} className="bg-white rounded-2xl shadow-sm border border-[var(--saathi-border-light)]/50 p-5 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:shadow-md transition-shadow">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 flex-1">
                <div>
                  <p className="text-xs text-[var(--saathi-text-muted)] font-medium mb-1">Seller (Wholesaler)</p>
