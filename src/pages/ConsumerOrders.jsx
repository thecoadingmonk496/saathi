  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-6 pb-24">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-800 tracking-tight">Your Purchases</h1>
          <p className="text-sm text-gray-500 font-medium mt-1">Review and approve purchases from Retailers</p>
        </div>
      </div>
          ...
          orders.map(order => (
            <div key={order._id} className="bg-white rounded-2xl shadow-sm border border-emerald-100/50 p-5 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:shadow-md transition-shadow">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 flex-1">
                <div>
                  <p className="text-xs text-gray-500 font-medium mb-1">Seller (Retailer)</p>
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">₹{order.price * order.quantity}</p>
                </div>
              </div>
