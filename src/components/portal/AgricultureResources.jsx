...
export default function AgricultureResources() {
  const resources = [
    ...
    },
    {
      ...
      title: 'Produce Blockchain Ledger',
      hindiTitle: 'ब्लॉकचेन सत्यापन खाता',
      description: 'Verify harvest provenance, moisture level certifications, and transaction transparency on the smart ledger.',
